#!/nix/store/473ny4r08xdvp12y95wq2vs97mnf83cv-chez-scheme-10.3.0/bin/scheme --program
...
(define PreludeC-45IO-u--__Impl_HasLinearIO_IO (cons (vector (vector (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8920) (lambda (eta-0) (PreludeC-45IO-u--map_Functor_IO u--func arg-8920 eta-0)))))) (lambda (u--a) (lambda (arg-9959) (lambda (eta-0) arg-9959))) (lambda (u--b) (lambda (u--a) (lambda (arg-9965) (lambda (arg-9972) (lambda (world-4) (let ((act-5 (arg-9965 world-4))) (let ((act-3 (arg-9972 world-4))) (act-5 act-3))))))))) (lambda (u--b) (lambda (u--a) (lambda (arg-10444) (lambda (arg-10447) (lambda (world-0) (let ((act-1 (arg-10444 world-0))) ((arg-10447 act-1) world-0))))))) (lambda (u--a) (lambda (arg-10458) (lambda (world-0) (let ((act-1 (arg-10458 world-0))) (act-1 world-0)))))) (lambda (u--a) (lambda (arg-13142) arg-13142))))
(define PreludeC-45IO-u--__Impl_HasIO_C-36io (lambda (arg-1) (cons (let ((e-1 (car arg-1))) e-1) (lambda (u--a) (lambda (arg-13076) (let ((e-2 (cdr arg-1))) ((e-2 'erased) arg-13076)))))))
(define PreludeC-45IO-putStrLn (lambda (arg-1 arg-2) (let ((e-2 (cdr arg-1))) ((e-2 'erased) (lambda (eta-0) (PreludeC-45IO-prim__putStr (string-append arg-2 "\xa;") eta-0))))))
           ...
           (collect
            ...
            (let loop ([c this-counter] [gen 0])
              (cond
                ...
                [else
                 gen]))))]))))
(PrimIO-unsafePerformIO (PreludeC-45IO-putStrLn (PreludeC-45IO-u--__Impl_HasIO_C-36io PreludeC-45IO-u--__Impl_HasLinearIO_IO) "Hello"))
