...
envOption names envVar = Alt (Option names "ENV_VAR" Nothing) (Pure ("<$" ++ envVar ++ ">"))

-- ||| Create a parser with environment fallback and default.
export envOptionWithDefault : List String -> String -> String -> Parser String
envOptionWithDefault names envVar defaultValue = Alt (Option names "ENV_VAR" Nothing) (Pure defaultValue)
